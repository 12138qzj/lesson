...
import com.example.yexin.mylastpj.bean.SpinnearBean;
import com.example.yexin.mylastpj.util.DateTimeHelper;
...
public class MainActivity extends Activity {
    ...
    private OptionsPickerView mTimePickerView;//日期选择器
    ...
    private TextView startdateTv2;//开始日期2
    ...
    private void initViews() {
        ...
        startdateTv2 = findViewById(R.id.startdateTv2);
    }
    ...
    private void initTimeOptionPicker(){
        mTimePickerView=new OptionsPickerBuilder(MainActivity.this, new OnOptionsSelectListener() {
            @Override
            public void onOptionsSelect(int options1, int options2, int options3, View v) {
                String tx2 = mTimeList.get(options2);
                startdateTv2.setText(tx2);
            }
            ...
            public void onOptionsSelectChanged(int options1, int options2, int options3) {
                ...
                .build();
        mTimePickerView.setPicker(mTimeList);
        //mTimePickerView.setPicker(mTimeList);
    }
    //初始化爱好选择器
    ...
    private void initStartTimePicker() {
        ...
        mStartDatePickerView = new TimePickerBuilder(MainActivity.this, new OnTimeSelectListener() {
            ...
            public void onTimeSelect(Date date, View v) {//选中事件回调
                ...
                startdateTv.setText(DateTimeHelper.formatToString(date,"MM月dd "));
            }
        })
                .setDecorView((RelativeLayout)findViewById(R.id.activity_rootview))//必须是RelativeLayout，不设置setDecorView的话，底部虚拟导航栏会显示在弹出的选择器区域
    ...
    private void initEvents() {
        ...
        startdateTv2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
